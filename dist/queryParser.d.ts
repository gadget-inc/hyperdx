...
import { J as JSDataType, M as Metadata } from './clickhouse-Bxc0SAEw.js';
...
declare class CustomSchemaSQLSerializerV2 extends SQLSerializer {
    ...
    constructor({ metadata, databaseName, tableName, connectionId, implicitColumnExpression, fallbackAttributeExpression, columnAliases, }: {
        metadata: Metadata;
    } & CustomSchemaConfig);
    /**
