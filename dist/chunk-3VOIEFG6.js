...
function timeBucketByGranularity(start, end, granularity) {
  ...
  while (current < end) {
    ...
    current = _datefns.add.call(void 0, current, {
...
var formatDate = (date, {
  ...
  return isUTC ? _datefnstz.formatInTimeZone.call(void 0, date, "Etc/UTC", formatStr) : _datefns.format.call(void 0, date, formatStr);
};
...
exports.isBrowser = isBrowser; exports.isNode = isNode; exports.splitAndTrimCSV = splitAndTrimCSV; exports.splitAndTrimWithBracket = splitAndTrimWithBracket; exports.getFirstTimestampValueExpression = getFirstTimestampValueExpression; exports.Granularity = Granularity; exports.hashCode = hashCode; exports.convertDateRangeToGranularityString = convertDateRangeToGranularityString; exports.convertGranularityToSeconds = convertGranularityToSeconds; exports.toStartOfInterval = toStartOfInterval; exports.timeBucketByGranularity = timeBucketByGranularity; exports._useTry = _useTry; exports.parseJSON = parseJSON; exports.formatDate = formatDate;
