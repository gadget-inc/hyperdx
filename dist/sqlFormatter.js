"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _sqlformatter = require('sql-formatter');
const functions = [
...
const reservedSelect = _sqlformatter.expandPhrases.call(void 0, ["SELECT [ALL | DISTINCT]"]);
const reservedClauses = _sqlformatter.expandPhrases.call(void 0, [
  // queries
  "WITH [RECURSIVE]",
  "FROM",
  "WHERE",
...
const standardOnelineClauses = _sqlformatter.expandPhrases.call(void 0, [
  "CREATE [GLOBAL TEMPORARY | LOCAL TEMPORARY] TABLE"
]);
const tabularOnelineClauses = _sqlformatter.expandPhrases.call(void 0, [
  // - create:
...
const reservedSetOperations = _sqlformatter.expandPhrases.call(void 0, [
  "UNION [ALL | DISTINCT]",
  "EXCEPT [ALL | DISTINCT]",
  "INTERSECT [ALL | DISTINCT]"
]);
const reservedJoins = _sqlformatter.expandPhrases.call(void 0, [
  "JOIN",
...
const reservedPhrases = _sqlformatter.expandPhrases.call(void 0, [
...
function format(query) {
  return _sqlformatter.formatDialect.call(void 0, query, { dialect: clickhouse });
}
...
exports.dataTypes = dataTypes; exports.format = format; exports.functions = functions; exports.keywords = keywords;
