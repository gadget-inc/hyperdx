"use strict";Object.defineProperty(exports, "__esModule", {value: true});// src/sqlFormatter.ts
...
var reservedSelect = _sqlformatter.expandPhrases.call(void 0, ["SELECT [ALL | DISTINCT]"]);
var reservedClauses = _sqlformatter.expandPhrases.call(void 0, [
  // queries
  "WITH [RECURSIVE]",
  "FROM",
  "WHERE",
...
var standardOnelineClauses = _sqlformatter.expandPhrases.call(void 0, [
  "CREATE [GLOBAL TEMPORARY | LOCAL TEMPORARY] TABLE"
]);
var tabularOnelineClauses = _sqlformatter.expandPhrases.call(void 0, [
  // - create:
...
var reservedSetOperations = _sqlformatter.expandPhrases.call(void 0, [
  "UNION [ALL | DISTINCT]",
  "EXCEPT [ALL | DISTINCT]",
  "INTERSECT [ALL | DISTINCT]"
]);
var reservedJoins = _sqlformatter.expandPhrases.call(void 0, [
  "JOIN",
...
var reservedPhrases = _sqlformatter.expandPhrases.call(void 0, [
