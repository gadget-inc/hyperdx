...
var MetricTableSchema = _zod.z.object(
...
var SQLIntervalSchema = _zod.z.string().regex(/^\d+ (second|minute|hour|day)$/);
var SearchConditionSchema = _zod.z.string();
var SearchConditionLanguageSchema = _zod.z.enum(["sql", "lucene"]).optional();
var AggregateFunctionSchema = _zod.z.enum([
  "avg",
  "count",
  "count_distinct",
  "last_value",
...
var AggregateFunctionWithCombinatorsSchema = _zod.z.string().regex(/^(\w+)If(State|Merge)$/);
var RootValueExpressionSchema = _zod.z.object({
  aggFn: _zod.z.union([
...
var DerivedColumnSchema = _zod.z.intersection(
...
var SelectListSchema = _zod.z.array(DerivedColumnSchema).or(_zod.z.string());
var SortSpecificationSchema = _zod.z.intersection(
  RootValueExpressionSchema,
  _zod.z.object({
    ordering: _zod.z.enum(["ASC", "DESC"])
  })
);
var SortSpecificationListSchema = _zod.z.array(SortSpecificationSchema).or(_zod.z.string());
var LimitSchema = _zod.z.object({
  limit: _zod.z.number().optional(),
  offset: _zod.z.number().optional()
});
var ChSqlSchema = _zod.z.object({
  sql: _zod.z.string(),
  params: _zod.z.record(_zod.z.string(), _zod.z.any())
});
var SelectSQLStatementSchema = _zod.z.object({
...
var AlertIntervalSchema = _zod.z.union([
  _zod.z.literal("1m"),
  _zod.z.literal("5m"),
  _zod.z.literal("15m"),
  _zod.z.literal("30m"),
...
var SqlAstFilterSchema = _zod.z.object({
  type: _zod.z.literal("sql_ast"),
  operator: _zod.z.enum(["=", "<", ">", "!=", "<=", ">="]),
  left: _zod.z.string(),
  right: _zod.z.string()
});
var FilterSchema = _zod.z.union([
  _zod.z.object({
...
var _ChartConfigSchema = _zod.z.object({
  ...
  caseSensitive: _zod.z.boolean().optional()
});
var CteChartConfigSchema = _zod.z.intersection(
  _ChartConfigSchema.partial({ timestampValueExpression: true }),
  SelectSQLStatementSchema
);
var ChartConfigSchema = _zod.z.intersection(
...
var SavedChartConfigSchema = _zod.z.intersection(
  _zod.z.intersection(
    _zod.z.object({
      name: _zod.z.string(),
      source: _zod.z.string(),
...
var DashboardSchema = _zod.z.object({
  id: _zod.z.string(),
...
var ConnectionSchema = _zod.z.object({
  id: _zod.z.string(),
  name: _zod.z.string(),
  host: _zod.z.string(),
...
var SourceBaseSchema = _zod.z.object({
  id: _zod.z.string(),
...
var SourceSchema = _zod.z.discriminatedUnion("kind", [
...
exports.MetricsDataType = MetricsDataType; exports.DisplayType = DisplayType; exports.MetricTableSchema = MetricTableSchema; exports.SQLIntervalSchema = SQLIntervalSchema; exports.SearchConditionSchema = SearchConditionSchema; exports.SearchConditionLanguageSchema = SearchConditionLanguageSchema; exports.AggregateFunctionSchema = AggregateFunctionSchema; exports.AggregateFunctionWithCombinatorsSchema = AggregateFunctionWithCombinatorsSchema; exports.RootValueExpressionSchema = RootValueExpressionSchema; exports.DerivedColumnSchema = DerivedColumnSchema; exports.SelectListSchema = SelectListSchema; exports.SortSpecificationSchema = SortSpecificationSchema; exports.SortSpecificationListSchema = SortSpecificationListSchema; exports.LimitSchema = LimitSchema; exports.ChSqlSchema = ChSqlSchema; exports.SelectSQLStatementSchema = SelectSQLStatementSchema; exports.WebhookService = WebhookService; exports.AlertThresholdType = AlertThresholdType; exports.AlertState = AlertState; exports.AlertSource = AlertSource; exports.AlertIntervalSchema = AlertIntervalSchema; exports.zAlertChannelType = zAlertChannelType; exports.zAlertChannel = zAlertChannel; exports.zSavedSearchAlert = zSavedSearchAlert; exports.zTileAlert = zTileAlert; exports.AlertBaseSchema = AlertBaseSchema; exports.ChartAlertBaseSchema = ChartAlertBaseSchema; exports.AlertSchema = AlertSchema; exports.SavedSearchSchema = SavedSearchSchema; exports.NumberFormatSchema = NumberFormatSchema; exports.SqlAstFilterSchema = SqlAstFilterSchema; exports.FilterSchema = FilterSchema; exports._ChartConfigSchema = _ChartConfigSchema; exports.CteChartConfigSchema = CteChartConfigSchema; exports.ChartConfigSchema = ChartConfigSchema; exports.SavedChartConfigSchema = SavedChartConfigSchema; exports.TileSchema = TileSchema; exports.DashboardSchema = DashboardSchema; exports.DashboardWithoutIdSchema = DashboardWithoutIdSchema; exports.ConnectionSchema = ConnectionSchema; exports.SourceKind = SourceKind; exports.SourceSchema = SourceSchema; exports.sourceSchemaWithout = sourceSchemaWithout;
